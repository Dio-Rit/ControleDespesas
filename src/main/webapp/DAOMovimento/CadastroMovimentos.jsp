...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample04">
                    <div class="float-end" id="navbarsExampleDefault">
                        ...
                        <form action="../DAOMovimento/ListarMovimentos.jsp">
        ...
        <div id="CadastroMovimento">
            <form name="AcaoMovimento" id="AcaoMovimento" method="post" action="../AcaoMovimento?param=SalvarMovimento">
                <center>
