                ...
                <main class="col-sm-12 ml-sm-auto col-md-12 " role="main">
                    <div>
                        <section layout:fragment="content">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-10">Lista de Pessoas</div>
                                    <div class="col-sm-1">
                                        <a href="../DAOPessoa/CadastroPessoas.jsp" class="btn btn-dark active" role="button"
                                ...
                                <%
                                    ArrayList<Pessoa> pessoa = new PessoaDAO().consultarTodos();
                                %>
                                        ...
                                        <tbody>
                                            <%
                                                for (int i = 0; i < pessoa.size(); i++) {
                                                    Pessoa categ = pessoa.get(i);
                                                    if (categ.getX().equals("A")) {
                                            %>
                                            <tr>
                                                <td><%= categ.getId_pessoa()%></td>
                                                <td><%= categ.getNome()%></td>
                                                <td><%= categ.getCpf()%></td>
                                                <td>
                                                    <a href="../AcaoPessoa?param=EdPessoa&id=<%= categ.getId_pessoa()%>"  class="btn btn-success" title="Editar" >
